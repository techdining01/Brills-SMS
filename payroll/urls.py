...
urlpatterns = [
    ...
    path("admin/periods/", views.period_list, name="period_list"),
    path("admin/periods/<int:pk>/", views.period_detail, name="period_detail"),

    path("admin/records/", views.record_list, name="record_list"),
    path("admin/records/<int:pk>/", views.record_detail, name="record_detail"),
...
urlpatterns += [
    ...
    # Payroll generation
    path("period/<int:period_id>/generate/",
         views.generate_payroll_bulk,
         name="generate_payroll_bulk"),

    # Approvals
    path("record/<int:record_id>/approve/bursar/",
         views.bursar_approve_payroll,
         name="bursar_approve"),

    path("record/<int:record_id>/approve/admin/",
         views.admin_approve_payroll,
         name="admin_approve"),

    # Payment batch
    path("period/<int:period_id>/batch/",
         views.create_payment_batch_view,
         name="create_payment_batch"),

    # Paystack
    path("transfer/<int:transaction_id>/run/",
         views.run_paystack_transfer,
         name="run_transfer"),
