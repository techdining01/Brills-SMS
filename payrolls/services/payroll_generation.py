...
from payroll.models import PayrollRecord, Payee, PayrollGenerationLog, PayrollLineItem, PayrollApproval
...
def generate_payroll_for_payee(payee, payroll_period, generated_by):
    ...
    AuditLog.objects.create(
        ...
        description=f"Generated payroll for {payee.user.get_full_name()}",
    )
    
    # Initialize approval record
    PayrollApproval.objects.create(payroll_record=payroll)
